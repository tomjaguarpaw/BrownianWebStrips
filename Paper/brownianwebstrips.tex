...
\usepackage[margin=40pt]{caption}
% vv Remove these two lines to return to single spacing
\usepackage{setspace}
\doublespacing
% ^^
...
% PTRF review asked us to change phi_{ab} to phi_{a,b}
% I did this in an adhoc way, but if we were going
% to do substantial further work on this paper it
% should be done for phi, F and R at once with a common
% newcommand
\newcommand{\commafactor}[2]{\mathcal{F}_{#1,#2}}
\newcommand{\factor}[2]{\commafactor{#1}{#2}}
...

{
  ...
  \input{convergence_of_the_perturbed_process.tex}
  \input{recovering_from_strips.tex}
%  \input{ohad.tex}
%  \input{tom.tex}
  \input{results_on_noise.tex}
  \input{remarks_and_open_problems.tex}
