...
\begin{center}
  \begin{tabular}{| l || c | c | c | c | c | }
    ...
    \hline
    \hline
    $\statenoweb$ & \includegraphics[scale=0.2]{state2dnc.eps} & indep. & $\statewebapart$ & hits $\pm\epsilon$ & $x=\pm\epsilon$ \\
    \hline
    \multirow{2}{*}{$\statewebapart$} & \multirow{2}{*}{\includegraphics[scale=0.2]{state2dc.eps}} & \multirow{2}{*}{indep.} & $\statenoweb$ & hits $0$ & $x=0$ \\ \cline{4-6}
        &  &  & $\statewebtogether$ & hits $\sampled$ & $x=y$\\
    \hline
    $\statewebtogether$  & \includegraphics[scale=0.2]{state1d.eps} & equal & $\statenoweb$ &  hits $0$ & $y=x=0$\\
    \hline
  \end{tabular}
\end{center}
