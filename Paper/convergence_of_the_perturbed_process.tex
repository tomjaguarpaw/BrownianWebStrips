...
We now \TODO{factorize}{what's the right word?} $\twodim=(\twodim^1,\twodim^2)$ into two one dimensional walks $\tdh=\twodim^1+\twodim^2,\tdv=\twodim^1-\twodim^2$. We now show to following two
auxiliary claims:
