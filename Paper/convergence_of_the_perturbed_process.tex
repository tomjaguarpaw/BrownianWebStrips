...
$\rotproc=(\tdh,\tdv)=(\twodim^1+\twodim^2,\twodim^1-\twodim^2)$. Observe
that whenever $\twodim$ follows the law of a two-dimensional Brownian motion,
so does $\rotproc$, though its motion is scaled by $\sqrt{2}$.
