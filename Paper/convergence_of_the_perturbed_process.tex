...
Choose arbitrarily $\delta>0$, and define $\boundarylines=\{(x,y) \ :\  |x-y|=\delta \}$.
\TODO{}{Repetition of ``arbitrary'' is clumsy}
Since $\delta$ is arbitrary, the above lemma can now be rephrased as
\begin{lemma*}
