...
\begin{center}
  \begin{tabular}{| l || c | c | c | c | }
    ...
    \hline
    \hline
    $\statenoweb$ & \includegraphics[scale=0.2]{state2dnc.eps} & indep. & $\statewebapart$ & hits $\pm\epsilon$ \\
    \hline
    \multirow{2}{*}{$\statewebapart$} & \multirow{2}{*}{\includegraphics[scale=0.2]{state2dc.eps}} & \multirow{2}{*}{indep.} & $\statenoweb$ & hits $0$ \\ \cline{4-5}
        &  &  & $\statewebtogether$ & hits $\sampled$ \\
    \hline
    $\statewebtogether$  & \includegraphics[scale=0.2]{state1d.eps} & equal & $\statenoweb$ &  hits $0$ \\
    \hline
    \hline
    $\statenoweb$ & A & indep. & $\statewebapart$ & $x=\pm\epsilon$ \\
    \hline
    \multirow{2}{*}{$\statewebapart$} & \multirow{2}{*}{B} & \multirow{2}{*}{indep.} & $\statenoweb$ & $x=0$ \\ \cline{4-5}
        &  &  & $\statewebtogether$ & $x=y$ \\
    \hline
    $\statewebtogether$  & C & equal & $\statenoweb$ & $y=x=0$ \\
    \hline
  \end{tabular}
\end{center}
\caption{States and transitions of $\twodim$}
\FIXME{}{Table needs finishing}
\end{figure}
