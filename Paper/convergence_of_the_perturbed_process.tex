...

{
  ...
  \excursionstart_2 < \cdots$. We say ``the probability that an excursion 
...
\[
\frac{\P\left(\text{an excursion hits $\boundarylines$}\right)}
     {\P\left(\text{an excursion hits $\farpoint$}\right)}
        \to 0 \text{ as } \epsilon\to0
\]

By the fact that the probability of any of those things happening
on different excursions are independent, and considering the fact
that one of them will eventually happen, we deduce Lemma
\ref{lem:prob-hit-boundary-o1}.
