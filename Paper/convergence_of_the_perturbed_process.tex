...
$\sampled$ equal to $\resamplede$.  (If $\sampled$ and $\resamplede$
start at 0 then $\twodim$ immediately transitions to state
$\statenoweb$).
...
The random set $\{t \ge 0 : \twodim_t = \origin\}$ is almost surely
