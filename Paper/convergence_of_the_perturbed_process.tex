...
\begin{itemize}
\item If $\resamplede$ follows
$\indepbm$ we say it is in $\statenoweb$.
\item If $\resamplede$ follows $\webnoargs$
and is not coalesced with $\sampled$ we say it is in $\statewebapart$.
\item Finally,
if $\resamplede$ follows $\webnoargs$ and is coalesced with $\sampled$ we say it is in
$\statewebtogether$.
\end{itemize}
Observe that $\twodim$ always starts
in $\statewebtogether$. Further notice that from $\statewebtogether$ $\twodim$
...
Observe that this process always follows the law of a two-dimensional
Brownian motion outside the line $x = y$.
