...
\begin{proof}
  ...
  \item the probability that $f \mapsto \restrict{I}{f}$ is continuous
    at $X$ is $1$
  \end{itemize}
  so by the continuous mapping theorem (see for example
  \FIXME{Billingsley 1999, p. 21, Theorem 2.7}{make this a reference,
    and check it}) $\restrict{I}{\resamplede} \to^\P
  \restrict{I}{\sampled}$.  Note further that
  \begin{itemize}
