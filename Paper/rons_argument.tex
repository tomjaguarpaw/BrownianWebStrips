...
\newcommand{\probhitboundaryis}[1]{Fix $P > 0$.  The probability that $Y$ \FIXME{started from
  $0$}{don't really want to start it at $0$} hits $\boundarylines$ before $\farpoint$ is #1}
