...
the \TODO{appendix}{do the appendix}.)  Later the Brownian web was
shown by Tsirelson in [] to be a one-dimensional black noise -- i.e.\
when considered as a time-indexed random process.  We extend this
result by showing that the Brownian web is in fact a two-dimensional
black noise, only the second such known after Schramm and Smirnoff's
recent result on the scaling limit of critical planar
percolation \TODO{}{citation}.  Our main result in this work is the
following theorem:
