...
\text{ or }x(t)^2+(e_\epsilon(t)-x(t))^2<\delta\right)=1$$
...
$x(t)^2+\frac{(e_\epsilon(t)-x(t))^2}{2}=\delta$, then the probability
...
$x(s_i)^2+\frac{(e_\epsilon(s_i)-x(s_i))^2}{2}=\delta$ then by the definition of
...
\begin{proof}
 ...
 infers \ref{m13} and \ref{m21}. The proofs of \ref{m22}, \ref{m23} and \ref{m24}
...
\ref{prop:winlose1}. Indeed, suppose that on time $t_0$ we have
