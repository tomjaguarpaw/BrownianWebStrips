...
Equivalently the two dimensional process $(x(t),\eeps(t)-x(t))$
...
$x(t)^2+\frac{(\eeps(t)-x(t))^2}{2}=1$, then the probability
that $x(t)=\eeps(t)=\pm1$ is at least $1-O(\frac1{\log\epsilon})$.
\end{propos}
